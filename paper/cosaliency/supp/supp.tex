...
This supplemental material file provides additional experimental results for our submitted paper titled ``\toolname-palette: Co-saliency based Colorization for Comparing Categorical Visualizations''.
...
\item \LinkTo{pilotStudy}%Pilot study details and statistics;
\vspace{-2mm}
\item \LinkTo{colorBlindness}%Pilot study details and statistics;
\vspace{-2mm}
...
\CreateLink{badcaseAB}{Bad Case for Alpha Blending}
