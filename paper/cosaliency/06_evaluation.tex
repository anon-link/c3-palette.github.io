...
We evaluated the effectiveness of our method on supporting juxtaposed visual comparisons for both scatterplots and bar charts.% and the discriminability for reading scatterplots. % by applying it to scatterplots, as scatterplots are commonly used  for such comparisons.
...
\noindent{\textbf{Procedure. }}
The procedure of this experiment is same with ~\cite{Ondov19} except 