...
data <- data_total
for(i in 1:6){
  ciplotManual(data[data$datasetGroup == (i-1),], "error", "conditionName", i)
}

# for different change magnitude, check error ~ conditionName
for(i in 1:3){
  ciplotManual(data[data$changeMagnitude == (i-1),], "error", "conditionName", i)
}
