...
saveImg <- function(name){
  if(save_img_sign){
    #ggsave(paste("results", "formal", name, sep = "/"), width = 10, height = 6, useDingbats=FALSE)
    ggsave(paste("results", "formal", name, sep = "/"), width = 6, height = 4, useDingbats=FALSE)
  }
}
```
...
# Model2: error ~ ... condition + change type ...
...
saveImg("cosaliency-error-conditionName-total.pdf")
ciplot(data, "accuracy", "conditionName", "Total")
saveImg("cosaliency-accuracy-conditionName-total.pdf")
ciplot(data, "totalTime", "conditionName", "Total")
saveImg("cosaliency-totalTime-conditionName-total.pdf")
...
saveImg("cosaliency-error-changeMagnitude-total.pdf")
ciplot(data, "totalTime", "changeMagnitude", "Total")
saveImg("cosaliency-totalTime-changeMagnitude-total.pdf")
...
saveImg("cosaliency-error-changeType-total.pdf")
ciplot(data, "totalTime", "changeType", "Total")
saveImg("cosaliency-totalTime-changeType-total.pdf")
```
...
saveImg("cosaliency-error-conditionName-powerAnalysis.pdf")
```
...
saveImg("cosaliency-totalTime-conditionName-powerAnalysis.pdf")
```
...
ciplot(data, "error", "conditionName", "Total")
saveImg("coseparability-error-conditionName-total.pdf")
ciplot(data, "accuracy", "conditionName", "Total")
saveImg("coseparability-accuracy-conditionName-total.pdf")
ciplot(data, "totalTime", "conditionName", "Total")
saveImg("coseparability-totalTime-conditionName-total.pdf")
...
ciplotManual(data, "error", "conditionMagnitude", "Magnitude")
saveImg("coseparability-error-conditionMagnitude-total.pdf")
ciplotManual(data, "accuracy", "conditionMagnitude", "Magnitude")
saveImg("coseparability-accuracy-conditionMagnitude-total.pdf")
ciplotManual(data, "totalTime", "conditionMagnitude", "Magnitude")
saveImg("coseparability-totalTime-conditionMagnitude-total.pdf")


if(nrow(data[data$changeType=="pos", ])>0){
  ciplot(data[data$changeType == "pos",], "error", "conditionName", "pos")
  saveImg("coseparability-error-conditionName-pos.pdf")
  ciplot(data[data$changeType == "pos",], "totalTime", "conditionName", "pos")
  saveImg("coseparability-totalTime-conditionName-pos.pdf")
  
  ciplot(data[data$changeType == "num",], "error", "conditionName", "num")
  saveImg("coseparability-error-conditionName-num.pdf")
  ciplot(data[data$changeType == "num",], "totalTime", "conditionName", "num")
  saveImg("coseparability-totalTime-conditionName-num.pdf")
  
  ciplotManual(data[data$changeType == "pos",], "error", "conditionMagnitude", "pos")
  saveImg("coseparability-error-conditionMagnitude-pos.pdf")
  ciplotManual(data[data$changeType == "pos",], "totalTime", "conditionMagnitude", "pos")
  saveImg("coseparability-totalTime-conditionMagnitude-pos.pdf")
  
  ciplotManual(data[data$changeType == "num",], "error", "conditionMagnitude", "num")
  saveImg("coseparability-error-conditionMagnitude-num.pdf")
  ciplotManual(data[data$changeType == "num",], "totalTime", "conditionMagnitude", "num")
  saveImg("coseparability-totalTime-conditionMagnitude-num.pdf")
  
  

  ciplot(data, "error", "changeMagnitude", "Total")
  saveImg("coseparability-error-changeMagnitude-total.pdf")
  ciplot(data, "totalTime", "changeMagnitude", "Total")
  saveImg("coseparability-totalTime-changeMagnitude-total.pdf")
  # ciplotManual(data[data$changeType=="pos", ], "error", "changeMagnitude", "pos")
  # ciplotManual(data[data$changeType=="num", ], "error", "changeMagnitude", "num")
  ciplot(data, "error", "changeType", "Total")
  saveImg("coseparability-error-changeType-total.pdf")
  ciplot(data, "totalTime", "changeType", "Total")
  saveImg("coseparability-totalTime-changeType-total.pdf")
}
...
powerAnalysisGraph(mean(df1$error), mean(df2$error), sd(df$error))
saveImg("coseparability-error-conditionName-powerAnalysis.pdf")
```